...
contains
  ...
  subroutine build_dft_exc_matrix(xcnr, max_l, num_alpha, poly_order, alpha, num_mesh_points, abcissa,&
      & weight, vxc, vtau, k_matrix)
        ...
        do kk = 1, poly_order(ii)
          ...
          do ll = jj, num_alpha(ii)
            ...
            do mm = start, poly_order(ii)
              ...
              call dft_exc_matrixelement(xcnr, num_mesh_points, weight, abcissa, vxc, vtau, alpha(ii, jj), kk,&
