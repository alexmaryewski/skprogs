...
module dft
  ...
  use xcfunctionals, only : xcFunctional, getExcVxc_LDA_PW91,&
      ...
      & getExcVxc_MGGA_TASK, getExcVxc_MGGA_TASK_CC, getExcVxc_MGGA_LAK
  use density, only : basis, basis_times_basis_times_r2, density_at_point, density_at_point_1st,&
      & density_at_point_2nd, tau_at_point, basis_times_basis, basis_1st_times_basis_1st_times_r2
...
contains
  ...
  subroutine density_grid(pp, max_l, num_alpha, poly_order, alpha,&
    ...
    case(xcFunctional%MGGA_LAK)
      call getExcVxc_MGGA_LAK(abcissa, dz, dzdr, rho, drho, sigma, tau, exc, vxc, vtau)
    case default
